    ...
    <section className="w-full animate-fade-in-up bg-white py-12 md:py-20">
      <div className="container mx-auto max-w-4xl px-5 text-center">
        ...
        <p className="mx-auto mt-4 max-w-3xl text-base text-[#505D6A] md:text-lg">
          Suas respostas mostram dificuldade para desacelerar à noite. Por isso, selecionamos o <span className="font-semibold text-primary">Método Sono Militar</span> para fazer você dormir rápido e acordar realmente descansado.
        </p>
        <div className="mt-8">
